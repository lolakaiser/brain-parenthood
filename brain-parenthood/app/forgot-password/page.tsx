      ...
      <div style={{
        ...
        {status === 'sent' ? (
          <div style={{ textAlign: 'center' }}>
            ...
            <h1 style={{ fontSize: '20px', fontWeight: 'bold', color: '#111827', marginBottom: '8px' }}>Check your email</h1>
          ...
          <>
            <div style={{ textAlign: 'center', marginBottom: '28px' }}>
              <h1 style={{ fontSize: '20px', fontWeight: 'bold', color: '#111827', marginBottom: '4px' }}>Forgot password?</h1>
              <p style={{ color: '#9CA3AF', fontSize: '14px' }}>Enter your email and we'll send a reset link</p>
            </div>
